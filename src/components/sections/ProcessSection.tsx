...
export const ProcessSection = ({ images }: ProcessSectionProps) => {
  return (
    <section className="py-20 px-4 bg-[#F9F7F6] relative overflow-hidden">
        ...
        <div className="space-y-12">
          ...
          >
            <div className="flex-shrink-0">
              <motion.div 
                className="w-20 h-20 bg-[#363331] rounded-full flex items-center justify-center text-[#F9F7F6] font-bold text-2xl font-right-grotesk" 
            ...
            >
              ...
              <p className="text-lg text-[#C6C0BE] leading-relaxed font-aeonik">
          ...
          >
            ...
            >
              ...
              <p className="text-lg text-[#C6C0BE] leading-relaxed font-aeonik">
                Com a pré-análise em mãos, nossa equipe entrará em contato diretamente via WhatsApp (em até 24h úteis) para apresentar os primeiros insights e agendar o melhor dia e horário para sua sessão.
              </p>
            </motion.div>
          </motion.div>
        </div>
