...
export const ProcessSection = ({
  ...
  return <section className="py-20 px-4 bg-[#F9F7F6] relative overflow-hidden" style={{
        ...
        <div className="space-y-12">
          ...
          scale: 1.02
            ...
            <div className="flex-shrink-0">
              <motion.div className="w-20 h-20 bg-[#363331] rounded-full flex items-center justify-center text-[#F9F7F6] font-bold text-2xl" whileHover={{
              rotate: 360,
              scale: 1.1
            }} transition={{
              duration: 0.5
          ...
          scale: 1.02
            ...
            once: true
              ...
              <p className="text-lg text-[#C6C0BE] leading-relaxed">Com a pré-análise em mãos, nossa equipe entrará em contato diretamente via WhatsApp (em até 24h úteis) para apresentar os primeiros insights e agendar o melhor dia e horário para sua sessão.</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
